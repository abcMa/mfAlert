/**
 * Super simple wysiwyg editor v0.7.4
 * http://summernote.org/
 *
 * summernote.js
...
(function (factory) {
    ...
    var ui = {
        ...
        showDialog: function ($dialog) {
            $dialog.modal('show').css({
                "margin-top": function () {
                    //return ($(window).height() / 2)-($("#addToContactGroupModal").find(".modal-content").height()/2);
            	   return "25%";
                },"overflow-y":"hidden"
            });;
        },
        ...
        this.insertImages = function (files) {
            $.each(files, function (idx, file) {
                ...
                if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
                    ...
                    paraData.append("file", files[idx]);
                    Iptools.uidataTool._uploadfileData({
                        data: paraData,
                        type: "picture"
                    }).done( function (path) {
                        self.insertImage(Iptools.DEFAULTS.serviceUrl + path, filename);
                    });
                }
            });
        };
...
//                       '</div>';
            '<div class="input-group">'+
               '<input type="text" readonly="true" class="form-control" placeholder="上传图片">'+
              ' <span class="input-group-addon" style=" background-color: #5bc0de;color: #fff;overflow: hidden;position: relative;">'+
               '<input  type="file" class="note-image-input" style="opacity: 0;cursor: pointer;position: absolute;top: 0px;right: 0px;font-size: 100px;">上传</span>'+
            '</div>';
...
//                       '</div>';
    ...
    var HelpDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = [
              '<p class="text-center">',
              '<a href="//summernote.org/" target="_blank">Summernote 0.7.4</a> · ',
