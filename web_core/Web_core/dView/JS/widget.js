...
widget = {
    ...
    */
    ...
    _bindingDomEvent: function () {
        ...
        widget._enableAccountBindingBankClear();
    },
    ...
    _init: function () {
        ...
        $(widget._UIDEFAULFS.mainPanel).html("");
        var d = document.createElement("div");
        $(d).attr("class", "row");
        var dm = document.createElement("div");
        $(dm).attr("class", "primary-content");
        var de = document.createElement("div");
        $(de).attr("class", "extra-content");
        ...
        Iptools.uidataTool._getApplets({
            ...
            $(d).append(dm);
            $(d).append(de);
            $(widget._UIDEFAULFS.mainPanel).append(d);
        });
    ...
    _setListAppletContent: function (options) {
        ...
        if (options.type != "extra") {
            ...
            $(listpanel).append(header, extrad);
        }
        return listpanel;
    },
    ...
    _setDetailAppletContent: function (options) {
        ...
        if (options.type == "main") {
            ...
            $(dlc).addClass("clear");
            $(options.panel).append(header, form, dlc);
        } else {
    ...
    _enableAccountBindingBankClear: function () {
        widget._addEventListener({
            container: "body",
            target: ".accountBindingBankClear",
            type: "click",
            event: function () {
                $("input[name='87_bank_id']").val("");
                $("input[name='87_bank_id']").data("key", "");
                $("input[name='87_card_no']").val("");
                $("input[name='87_prcptcb']").val("");
                $("input[name='87_province_id']").val("");
                $("input[name='87_city_id']").val("");
                $("input[name='87_child_bank_name']").val("");
                $("input[name='87_sign_paper_num']").val("");
                $("input[name='87_bank_id']").trigger("input");
                $("input[name='87_card_no']").trigger("input");
                $("input[name='87_prcptcb']").trigger("input");
                $("input[name='87_province_id']").trigger("input");
                $("input[name='87_city_id']").trigger("input");
                $("input[name='87_child_bank_name']").trigger("input");
                $("input[name='87_sign_paper_num']").trigger("input");
                $("input[name='87_bank_id']").trigger("blur");
                $("input[name='87_card_no']").trigger("blur");
                $("input[name='87_prcptcb']").trigger("blur");
                $("input[name='87_province_id']").trigger("blur");
                $("input[name='87_city_id']").trigger("blur");
                $("input[name='87_child_bank_name']").trigger("blur");
                $("input[name='87_sign_paper_num']").trigger("blur");
            }
        });
    },
};