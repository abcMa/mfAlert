	      ...
	      if(data.data){
	    	var obj = data.data;
			  ...
			  $("#inputEmail").val(picName);
               ...
               $("#endTime").val(obj[prefix+":end_time"]);
               $("#etime").html(obj[prefix+":end_time"]);
               
               $("#tel").val(obj[prefix+":contact_phone"]);
               $("#ptel").html(obj[prefix+":contact_phone"]);
               
               $("#inp").val(obj[prefix+":location"]);
               $("#address").html(obj[prefix+":location"]);
...
//                   $("#visitorEventTags").tagit();
               ...
               $(".section-siex-first b").html(obj[prefix+":button_text"]?obj[prefix+":button_text"]:"立即报名");
...
//        data:{
//            tenantI:Iptools.DEFAULTS.tenantId,
//            userId:Iptools.DEFAULTS.userId,
            appletId:campaignApplet
       // }
    }).done(function(data){
