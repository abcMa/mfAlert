        ...
        this.insertImages = function (files) {
            $.each(files, function (idx, file) {
                ...
                if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
                    ...
                    var url = "http://enterpriseserver.yizhangke.com:80/eis/v1/basic/file/uploadpic?tenantId=" + window.sessionStorage.getItem("tenantId") + "&type=jpg";
                    $.ajax({
                        url: url,
                        type: "POST",
                        data: paraData,
                        ...
                        contentType: false,
                        success: function (r) {
                            self.insertImage(serviceUrl + r, filename);
                        }
                    });
                }
            });
